...
export const metadata: Metadata = {
  title: "Register | One Crew",
  description: "Create your One Crew account to get started.",
};

export default function RegisterPage() {
  return (
    <div className="relative min-h-screen w-full bg-[#050505] text-[#e5e2e1] overflow-y-auto flex flex-col justify-between selection:bg-white selection:text-black">
      {/* Scanlines */}
      ...
      {/* Form */}
      <main className="relative z-10 flex-grow flex items-center justify-center mt-4 md:-mt-10 pb-12">
        <RegisterForm />
      </main>
    </div>
  );
